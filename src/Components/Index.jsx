...
const TestDnD = () => {
    ...
    return (
        <div className='drog-item' ref={drag} >
            Покупка {count} акций {tiker} на {amount}$
        </div>
    )
}

const MyDropTarget = ({children, count,  tiker, amount, ...props}) => {

    const [state, setState] = useState({count, tiker, amount})
